...
:uri-build-status: https://github.com/sc-sq-c-family-examples/linux-cmake-gh-actions-sc/actions/workflows/build.yml
:img-build-status: https://github.com/sc-sq-c-family-examples/linux-cmake-gh-actions-sc/actions/workflows/build.yml/badge.svg
...
.. Download the Download the https://sonarcloud.io/documentation/analysis/scan/sonarscanner/[Sonar Scanner]
.. Download the Download the https://sonarcloud.io/documentation/analysis/languages/cfamily/#analysis-steps-using-build-wrapper[Build Wrapper]
